          ...
          <main className="flex flex-col mt-28 gap-10 w-full max-w-[384px]">
            ...
            <form className="flex flex-col gap-4" onSubmit={handleSubmit(handleLoginSubmit)}>
              ...
              <footer className="flex flex-col gap-8">
                <button className="bg-purple-500 text-white font-bold py-4 rounded outline-none hover:bg-purple-400 hover:ring-1 hover:ring-purple-500 focus:ring-2 focus:ring-purple-400">
                  Entrar
                </button>
